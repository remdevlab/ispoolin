...
object Prefz : PrefsHelper {
    ...
    private var writeLogsOnRead: Boolean = false
    private var writeLogsOnWrite: Boolean = true

    internal fun setup(context: Context) {
        helper = CachedPrefsHelper().apply { setup(context) }
    }
    ...
    override fun configure(writeLogsOnRead: Boolean, writeLogsOnWrite: Boolean) {
        this.writeLogsOnRead = writeLogsOnRead
        this.writeLogsOnWrite = writeLogsOnWrite
    }
}
